---
name: line-behavior
description: LINE social behavior rules. Always active when handling LINE messages. Use for group chat silence rules, when to respond vs stay quiet, postback button displayText rules, 3-second ACK rule for media messages, and all LINE interaction protocol decisions.
...
- 記錄錯誤細節到 `~/.openclaw/workspace/memory/YYYY-MM-DD.md`
- 嘗試替代方案後再回報結果
...
原始位置：`~/.openclaw/workspace/projects/line-experience-lab/` 和 `~/.openclaw/workspace/`
