...
description: |
  ...
  觸發：吸地板、掃地機器人、roborock、掃地、清地板、吸塵器。
  不觸發：要拖地（roborock 不支援）、查掃地機器人型號（用搜尋）。
...
## 設備 ID（已登入）
- **Q Revo MaxV**: `21AVSkY89ZMEHfSeR6nYML`（主力機）
- **S5 Max**: `7Q77Gb4hxvGbnc40YeEjIM`

All commands need `--device_id` — 用上方對應的 ID。

### 1. 設置清掃模式 (`set_custom_mode`)
這個指令決定了吸力與拖地的行為：
- **安靜**: `roborock command --cmd set_custom_mode --params '[101]'`
- **標準**: `roborock command --cmd set_custom_mode --params '[102]'`
- **強力**: `roborock command --cmd set_custom_mode --params '[103]'`
- **Max (純吸塵/純掃地)**: `roborock command --cmd set_custom_mode --params '[104]'`
- **Max+**: `roborock command --cmd set_custom_mode --params '[105]'`

### 2. 拖地模式 (`set_mop_mode`)
- **標準**: `roborock command --cmd set_mop_mode --params '[300]'`
- **深度拖地**: `roborock command --cmd set_mop_mode --params '[301]'`
- **深度拖地+**: `roborock command --cmd set_mop_mode --params '[303]'`
- **快拖**: `roborock command --cmd set_mop_mode --params '[302]'`

### 3. 水量控制 (`set_water_box_custom_mode`)
- **關閉**: `roborock command --cmd set_water_box_custom_mode --params '[200]'`
- **低水量**: `roborock command --cmd set_water_box_custom_mode --params '[201]'`
- **中水量**: `roborock command --cmd set_water_box_custom_mode --params '[202]'`
- **高水量**: `roborock command --cmd set_water_box_custom_mode --params '[203]'`
- **自定義**: `roborock command --cmd set_water_box_custom_mode --params '[204]'`

### 4. 基座與維護控制
- **清洗拖布**: `roborock command --cmd app_start_wash`
- **烘乾拖布**: `roborock command --cmd app_start_dry`
- **自動集塵**: `roborock command --cmd app_start_collect_dust`
- **兒童鎖**: `roborock command --cmd set_child_lock --params '[1]'` (1 為開啟，0 為關閉)

### 5. 特定區域/房間清掃 (`app_segment_clean`)
