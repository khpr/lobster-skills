...
description: Telegram social behavior rules. Always active when handling Telegram messages. Use for group chat silence rules, when to respond vs stay quiet, callback_query rules, media message timing, and all Telegram interaction protocol decisions.
